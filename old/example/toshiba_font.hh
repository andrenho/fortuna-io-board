...
struct toshiba_font : public vga::text::Font {

    toshiba_font() : Font(8, 15, 0, 255) {}

    uint8_t pixels(uint8_t chr, uint8_t row) const override {
        // Font data for characters from ASCII 0 to 255
        static const uint8_t __in_flash() font_data[][15] = {
            // Character: ? (ASCII: 0)
            {
                0b00000000, // ........
                0b00000000, // ........
