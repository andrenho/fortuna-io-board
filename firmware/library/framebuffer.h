...
/*
void         fb_draw_character(uint16_t x, uint16_t y, text::Font const* font, uint8_t ch, FColor bg_color, FColor fg_color);
void         fb_draw_character(uint16_t x, uint16_t y, text::Font const* font, uint8_t ch, FColor fg_color);
*/
